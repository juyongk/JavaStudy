...
메서드형태3] 매개변수는 있으나 반환값은 없는 경우
	...
	즉시 출력하는 경우에 사용한다. 즉 값을 소비하는 형태의
	메서드이다.
 */
	...
	*/
	public static void main(String[] args) {
		...
		*/
		...
		/*
		main() 메서드에서 호출시 전달한 2개의 정수를 매개변수가
		순서대로 값을 받게 된다. 매개변수는 해당 메서드에 즉시 사용할
		수 있는 지역변수가 된다.
		*/
	static void myWantSum(int startNum, int endNum) {
		/*
		1에서 10까지의 합을 구하는 수열 프로그램을 시작값과
		종료값만 변수로 변경하여 원하는 구간의 합을 구하는
		프로그램으로 커스터마이징하여 재정의 하였다.
		*/
		int sum = 0;
