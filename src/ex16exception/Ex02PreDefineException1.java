...
public class Ex02PreDefineException1 {	
	...
	public static void main(String[] args) {
		...
		예외가 발생되면 JVM(자바가상머신)은 해당 예외에 관련된
		객체를 만들어 프로그램쪽으로 전달한다. 이때 catch절에서
		예외객체를 잡아 주는것을 "예외처리"라고 한다.
		만약 예외객체를 잡아주지 목하면 프로그램을 비정상적인 종료료 이어지게 된다.
		*/
		try {
			intArr[0] = 100;
			...
			/*
			예외가 발생되는 지점
			해당 코드가 실행될때 예외가 발생하게 되고 JVM이 예외객체를 
