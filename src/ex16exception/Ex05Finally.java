...
있는경우 기술하는 블럭이다. 단, 필수사항은 아니므로 꼭 필요한 경우에만
작성하면 된다.
...
public class Ex05Finally {
	...
	static void tryCatchFinally() {
		...
		try {
			...
			/* 해당 명령은 프로그램 실행자체를 종료한다. 즉
			콘솔창의 터미네이터 버튼을 누르는것과 동일하게 동작한다.
			따라서 try절에서 해당명령을 만나게되면 finally절은 
			실행되지 않는다. */
//			System.exit(0);
		}
	}
	public static void main(String[] args) {
		...
		/* NumberFormatException과 같은 예외는 발생된 지점에서
		  예외던지기를 하는것은 가능하나, 반드시 예외처리 해야만 프로
		  그램이 종료되지 않는다. 즉 예외객체에 따라 무시할 수 있는
		  것도 있지만, 이처럼 반드시 예외처리를 해야하는 것도 존재한다. 
