...
public class Ex06Define2Supplier {
	...
	public static void main(String[] args) {
		/*
		Supplier<T>
		: 공급자라는 의미를 가지고 있다. 매개변수는 없으나 리턴값은
		있는 get() 메서드가 정의되어 있다. 주로 데이터를 생성하여 
		리턴한다. 
		
		interface Supplier<T> {
			T get();
		}
		여기서 타입매개변수 T는 get() 메서드의 반환타입으로 정의된다.
		*/
	...
	/* 매개변수로 전달된 람다식을 통해 난수를 생성한다. 이때 cnt만큼
	반복하게 되므로 결국 난수 10개를 생성하여 List컬렉션에 저장한 후
	반환하고 있다. */
