...
public class Ex06Define4Function {
	...
	public static void main(String[] args) {
		/*
		Function<T, E>
		: 매개변수와 반환값을 둘 다 가지고있는 apply()
		추상메서드가 정의되어 있다. 개발자가 가장 많이 사용하는
		함수형 인터페이스이다.
		...
		*/
		/* 매개벼수는 String, 반환값은 Integer 타입으로 람다식을
		  정의한다. 문자열의 길이를 반환한다. */
		...
		//Human객체 생성 후 List<E> 컬렉션으로 변한한다.
		...
		Function<Human, Integer> getFunction = 
				(Human h) -> {
					return h.getScore(); 
				};
		...
		//향상된 for문을 통해 컬렉션 전체를 반복하여 점수를 출력한다. 
