...
public class InsertSQL extends IConnectImpl {
	...
	public void execute() {
		try {
			/* 1.쿼리문준비 : 값의 세팅을 위한 부분을 ?(인파라미터)로
			  기술한다.  */
			String query = "INSERT INTO member VALUES (?,?,?,?)";
			//2.prepared객체생성 : 준비한 쿼리문을 인수로 전달한다.
			...
			*/
			...
			/* 날짜입력1 : 날짜를 문자열로 입력하는경우. 기본서식을 맞춰서
			 기술한다. */
			psmt.setString(4, "2023-07-01");
			
			//날짜입력2 : Date형으로 입력하는 경우
			/* 현재 날짜를 Java에서 입력하는 경우 아래와 같이 변환과정을
