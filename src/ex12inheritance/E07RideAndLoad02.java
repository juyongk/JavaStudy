...
public class E07RideAndLoad02 {
	...
	public static void main(String[] args) {
		...
		/* 부모클래스의 참조변수로 자식인스턴스를 참조하면 부모의
		 영역까지만 접근할 수 있으므로 자식영역에 정의된 정의되어있는
		 메서드는 호출할 수 없다.
		 */
//		parent.study(); //에러발생
		parent.walk();
