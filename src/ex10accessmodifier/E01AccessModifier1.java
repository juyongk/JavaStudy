...
/* 해당 클래스는 접근지정자를 생략했으므로 default 클래스로
   정의된다. 이 경우 동일한 패키지 내에서만 접근할 수 있다. */
class DefaultClass1{
...
/* public 클래스는 해당 Java파일을 대표하는 클래스로 파일명과
   동일해야 한다. 또한 public 클래스는 자바파일당 단 하나만 정의할
   수 있다. 
...
public class E01AccessModifier1 {
	...
	public void publicMethod() {
		...
		/* private으로 선언된 메서드도 클래스 내부에서는
		   호출할 수 있다. 멤버변수와 동일한 접근범위를 가진다. */
		privateMethod();
	}
}
