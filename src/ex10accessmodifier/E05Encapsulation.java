...
class EncapsulLogic {
	...
	void doProcess() {
		...
		congratulationPoint.doCongratulationPoint();//3.가입축하포인트
		firstLoginEvent.doFirstLoginEvent();//4.첫로그인이벤트페이지
	}
}
...
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		*/
		...
		FirstLoginEvent firstLoginEvent = new FirstLoginEvent();//이벤트페이지 이동
		AutoLogin autoLogin = new AutoLogin();//자동로그인
		CongratulationPoint congratulationPoint = new CongratulationPoint();//축하포인트 지금
