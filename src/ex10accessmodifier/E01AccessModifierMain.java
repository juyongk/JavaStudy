...
/* 해당 클래스는 sub패키지에 작성되었으므로 사용을 위해서는
   반드시 임포트 후 사용해야 한다. */
...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("E01AccesssModifier1 객체 생성 및 접근");
		
		/* 동일한 패키지에 선언된 클래스이므로 import없이
		   인스턴스를 생성할 수 있다. */
		E01AccessModifier1 one = new E01AccessModifier1();
		
		/* private으로 선언된 멤버는 동일한 패키지에 선언하더라도
...
//		one.privateMethod();//에러발생
		...
		/* 다른 패키지에 선언된 클래스이므로 인스턴스 생성을 위해
		   import선언을 해야한다. 또한 패키지가 다르면 private,
