/*
 패키지 선언부 : 현재 작성하는 클래스의 위치를 결정하기 위한
 	선언으로 해당 클래스를 특정 패키지 하위에 묶에서 생성한다는
 	의미이다.
 */
package ex09package;
...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		...
		/*
		하나의 클래스안에 패키지는 다르나 같은 이름의 클래스를
		사용해야 한다면..
		방법1 : 클래스명 앞에 풀 패키지 경로를 기술한다.
		방법2 : 하나의 클래스는 import하고, 다른 하나는 풀
			패키지 경로를 기술한다.
		*/
		...
		Java에서 제공하는 클래스 중 대표적으로 Math를 예로
		들수있다. 난수 생성을 위해 별도의 인스턴스 생성없이 
		Math.random()을 통해 난수를 생성한다.
		*/
		...
		/* 클래스 작성시 패키지명까지 모두 입력한 상태로 사용하는
		   것이 가능하다. */
		System.out.println(
				ex09package.study.util.CommonUtil
					.isNumber("백20"));
	}
}
