...
/*
StringBuffer클래스
: String클래스는 기존문자열에 새로운 문자열을 추가하면 새롭게
...
public class E03StringBuilderBuffer {
	...
	public static void main(String[] args) {
		...
		*/
		...
		/* String 클래스는 문자열의 변경이 있는 경우 기존 메모리를
		   소멸하고 새로운 매모리를 할당한다. */
		str1 = str1 + "&Spring";
		if(str1==str2)
		...
		/* StringBuffer 클래스는 문자열을 저장하기 위해 기본
		   메모리를 16으로 할당한다. 차후 저장할 공간이 부족하면
		   자동으로 메모리를 확장한다. */
