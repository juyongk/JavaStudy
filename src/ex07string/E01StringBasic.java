...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/* 기본자료형의 경우 비교연산자 ==을 통해 값에 대한 비교를
		 한다. 변수에 값이 할당되어 있으므로 아래와 같이 비교할 수 있다. */
		int num1=10, num2=20;
		String numResult = (num1==num2) ?
				"데이터가같다" : "데이터가다르다";
		System.out.println("비교결과:"+ numResult);
		
		/* String클래스의 인스턴스 생성 방법
	 	: new를 이용한다. new를 통해 문자열 인스턴스를 생성하면
	 	동일한 문자열이라도 항상 새로운 메모리를 할당하게 된다. */
		String str1 = new String("Hello JAVA");
		String str2 = new String("Hello JAVA");
		
		/* str1, str2는 String인스턴스의 참조값을 가지고 있으므로
		   아래의 비교는 참조값(주소)에 대한 비교를 하게된다.
		   2개의 객체는 따로 생성되므로 다르다는 결과가 나온다. */
		if(str1==str2) {
