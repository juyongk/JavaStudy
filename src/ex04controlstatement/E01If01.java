...
/*
 if문 형식1
 	...
 	-즉 결과값이 boolean형으로 true/false를 반환해야 한다.
...
//		}
		...
		//논리And는 둘다 true일때만 true를 반환한다.
		if(num%2==0 && num>=10) {
			//2가지 조건 모두 만족하므로 해당 문장은 출력된다.
			System.out.printf("%n%d는 짝수이고 10보나 크거나같다.%n", num);
		}
		...
		*/
		...
		/* 조건 검사후 실행할 문장이 1개인 경우에는 중괄호를 생략할수
		...
		/* 아스키코드를 알고있을때의 구현방법. 문자 0과 9는 
		 아스키코드 48, 57에 해당하므로 구간내에 있는지 확인하면 된다. */
