...
-set의 기본적인 특성은 동일하다.
-따라서 중복은 허용되지 않는다.
-단 객체가 정렬되어 저장된다. 정렬의 기준은 개발자가 직접 정의할 수 있다. 
*/
...
class MyString implements Comparable<MyString>{
	...
	오버라이딩한다. 정렬의 기준은 단순하게 가나다라와 같은 순서가 될수도 있고,
	문자열의 길이에 따른 정렬이 될수도 있다.
	아래의 코드는 오름차순(작은것->큰석) 정렬일때 사용한다. 
...
public class Ex05TreeSetMain {
	...
	public static void main(String[] args) {
		...
		/* Java에서 제공하는 기본클래스인 경우 별도의 오버라이딩을 하지 
		  않아도 된다. */
