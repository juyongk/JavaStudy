...
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		아래와 같이 2차원 배열을 초기화하면 세로(행)3, 가로(열)4인
		배열이 생성된다. 초기화할 원소가 없는 부분은 null로 
		채워진다.
		...
		*/
		...
		for(int i=0 ; i<arr.length ; i++	) {
			...
			//각 행의 참조값을 출력한다.
			System.out.printf("%d행출력:%s\n", i, arr[i]);
		}
		
		/*
		2차원 배열에서 특정 원소에 접근하기 위해서는 2개의 배열기호가
		필요하다. 또한 값이 없는 원소, 즉 null로 채워져있는
		원소를 출력하면 예외가 발생한다. (배열의 인덱스를 초과했다는
		예외가 발생하게 된다.)
		*/
